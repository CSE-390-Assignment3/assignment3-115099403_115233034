...
class Algorithm_115099403_115233034_DFS : public AbstractAlgorithm {
private:
  int steps_;
...
public:
  Algorithm_115099403_115233034_DFS();
  Algorithm_115099403_115233034_DFS(AbstractAlgorithm &algorithm);
